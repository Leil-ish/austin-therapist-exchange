...
var BuildId = "nICK25i2-mo-wnegyrb8x";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/auth/callback/route": "/auth/callback", "/icon.svg/route": "/icon.svg", "/(public)/directory/[slug]/page": "/directory/[slug]", "/(public)/about/page": "/about", "/(public)/groups/[id]/page": "/groups/[id]", "/join/apply/page": "/join/apply", "/(public)/directory/page": "/directory", "/page": "/", "/member-access/page": "/member-access", "/login/page": "/login", "/reset-password/page": "/reset-password", "/(admin)/admin/page": "/admin", "/(admin)/admin/join-requests/page": "/admin/join-requests", "/(member)/member/endorsements/page": "/member/endorsements", "/(admin)/admin/reports/page": "/admin/reports", "/(member)/member/following/page": "/member/following", "/(member)/member/lists/page": "/member/lists", "/(member)/member/groups/[slug]/page": "/member/groups/[slug]", "/(member)/member/groups/page": "/member/groups", "/(member)/member/feed/page": "/member/feed", "/(member)/member/page": "/member", "/(member)/member/network/page": "/member/network", "/(member)/member/posts/new/page": "/member/posts/new", "/(member)/member/profile/page": "/member/profile", "/(member)/member/referrals/page": "/member/referrals", "/(public)/groups/page": "/groups" };
