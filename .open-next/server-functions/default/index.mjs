...
var BuildId = "OkjUhTkPRCprZiXj1YSHG";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/auth/callback/route": "/auth/callback", "/icon.svg/route": "/icon.svg", "/(public)/directory/[slug]/page": "/directory/[slug]", "/(public)/directory/page": "/directory", "/(public)/about/page": "/about", "/(public)/groups/[id]/page": "/groups/[id]", "/login/page": "/login", "/page": "/", "/join/apply/page": "/join/apply", "/reset-password/page": "/reset-password", "/member-access/page": "/member-access", "/(admin)/admin/reports/page": "/admin/reports", "/(admin)/admin/page": "/admin", "/(member)/member/endorsements/page": "/member/endorsements", "/(member)/member/feed/page": "/member/feed", "/(admin)/admin/join-requests/page": "/admin/join-requests", "/(member)/member/page": "/member", "/(member)/member/following/page": "/member/following", "/(member)/member/groups/[slug]/page": "/member/groups/[slug]", "/(member)/member/groups/page": "/member/groups", "/(member)/member/network/page": "/member/network", "/(member)/member/posts/new/page": "/member/posts/new", "/(member)/member/lists/page": "/member/lists", "/(member)/member/profile/page": "/member/profile", "/(member)/member/referrals/page": "/member/referrals", "/(public)/groups/page": "/groups" };
