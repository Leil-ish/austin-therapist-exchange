...
var BuildId = "9hjhIqJ9WkYeVPr-5Glke";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/auth/callback/route": "/auth/callback", "/icon.svg/route": "/icon.svg", "/(public)/directory/[slug]/page": "/directory/[slug]", "/(public)/groups/[id]/page": "/groups/[id]", "/join/apply/page": "/join/apply", "/(public)/directory/page": "/directory", "/login/page": "/login", "/reset-password/page": "/reset-password", "/(public)/about/page": "/about", "/member-access/page": "/member-access", "/page": "/", "/(public)/groups/page": "/groups", "/(admin)/admin/join-requests/page": "/admin/join-requests", "/(admin)/admin/page": "/admin", "/(member)/member/following/page": "/member/following", "/(admin)/admin/reports/page": "/admin/reports", "/(member)/member/network/page": "/member/network", "/(member)/member/endorsements/page": "/member/endorsements", "/(member)/member/groups/[slug]/page": "/member/groups/[slug]", "/(member)/member/page": "/member", "/(member)/member/lists/page": "/member/lists", "/(member)/member/feed/page": "/member/feed", "/(member)/member/profile/page": "/member/profile", "/(member)/member/posts/new/page": "/member/posts/new", "/(member)/member/groups/page": "/member/groups", "/(member)/member/referrals/page": "/member/referrals" };
